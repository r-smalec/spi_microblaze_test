...
#define SPI_DEVICE_ADDR   XPAR_AXI_QUAD_SPI_0_BASEADDR
#define UART_DEVICE_ADDR  XPAR_AXI_UARTLITE_0_BASEADDR
#define DATA_LEN 62
#define CHAR_LEN 1
#define SPACE_LEN 1
#define HEX_LEN 2
...
int spiInitialize() {
	...
	ConfigPtr = XSpi_LookupConfig(SPI_DEVICE_ADDR);
...
int uartInitialize() {
	return XUartLite_Initialize(&Uart, UART_DEVICE_ADDR);
}
