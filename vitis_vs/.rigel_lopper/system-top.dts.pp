# 0 "C:\\Users\\rsmalec\\Downloads\\vitis_vs\\spi_test_platform\\hw\\sdt\\system-top.dts"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "C:\\Users\\rsmalec\\Downloads\\vitis_vs\\spi_test_platform\\hw\\sdt\\system-top.dts"
/dts-v1/;
# 1 "C:\\Users\\rsmalec\\Downloads\\vitis_vs\\spi_test_platform\\hw\\sdt\\pl.dtsi" 1
/ {
 ...
 amba_pl: amba_pl {
  ...
  #address-cells = <1>;
  #size-cells = <1>;
  microblaze_0_axi_intc: interrupt-controller@41210000 {
   #interrupt-cells = <2>;
...
# 3 "C:\\Users\\rsmalec\\Downloads\\vitis_vs\\spi_test_platform\\hw\\sdt\\system-top.dts" 2
/ {
 device_id = "xcau15p";
 #address-cells = <1>;
 #size-cells = <1>;
 ...
 cpus_microblaze_0: cpus_microblaze@0 {
  address-map = <0x00000000 &microblaze_0_local_memory_dlmb_bram_if_cntlr_memory 0x00000000 0x20000>,
         ...
         <0x41210000 &microblaze_0_axi_intc 0x41210000 0x10000>,
